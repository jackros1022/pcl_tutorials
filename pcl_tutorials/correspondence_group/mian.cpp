...
main(int argc, char *argv[])
{
	...
	pcl::PointCloud<PointType>::Ptr scene_in(new pcl::PointCloud<PointType>());
	pcl::PointCloud<PointType>::Ptr scene_pt(new pcl::PointCloud<PointType>());
	...
	// pcl::search::FlannSearch<DescriptorT, DistT> flann_search_ 欧式距离查找
	...
	if (use_hough_)
	{
		...
		pcl::BOARDLocalReferenceFrameEstimation<PointType, NormalType, RFType> rf_est;	//局部坐标系
	...
	//  Visualization
	//
	pcl::visualization::PCLVisualizer viewer("基于对应点聚类的3D模型识别");
